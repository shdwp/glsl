...
/// @ingroup ext
///
/// Functions that generate common projection_ transformation matrices.
///
...
namespace glm
{
	...
	/// @param proj Specifies the current projection_ matrix
	...
	/// @param proj Specifies the projection_ matrix
